...
//
//public class Passenger_view_reply extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_passenger_view_reply);
//    }
//}
...
public class Passenger_view_reply extends AppCompatActivity {
    ...
    String[] complaints, reply, pid,date;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                        ...
                        li.setAdapter(new custom_view_reply(getApplicationContext(), pid, complaints, reply,date));
